...
class Translator(object):
    ...
    def _fast_translate_batch(self,
        ...
        for step in range(max_length):
            ...
            dec_out, dec_states = self.model.ext_decoder(decoder_input, src_features, dec_states, step=step)

            # Generator forward.
            log_probs = self.model.ext_generator.forward(dec_out.transpose(0,1).squeeze(0))
            ...
            pre_alive_seq = alive_seq.index_select(0, select_indices)
