...
class Batch(object):
    ...
    def _pad_2d(self, data, pad_id, width=-1, height=-1):
        ...
        rtn_data = [[d + [pad_id] * (height - len(d)) for d in sample] + [[pad_id] * height] * (width - len(sample)) for sample in data]
        return rtn_data
    ...
    def __init__(self, data=None, device=None, is_test=False):
        ...
        if data is not None:
            ...
            pre_tag_src = [x[5] for x in data]
            pre_tag_tgt = [x[6] for x in data]
...
class DataIterator(object):
    ...
    def preprocess(self, ex, is_test):
        ...
        if(is_test):
            return src, tgt, segs, clss, src_sent_labels, src_tags, tgt_tags, src_ext, src_txt, tgt_txt
        else:
            return src, tgt, segs, clss, src_sent_labels, src_tags, tgt_tags
