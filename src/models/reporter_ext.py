...
class ReportMgr(ReportMgrBase):
    ...
    def _report_step(self, lr, step, train_stats=None, valid_stats=None):
        ...
        if train_stats is not None:
            ...
            self.log('Train acc: %g' % train_stats.accuracy())
        ...
        if valid_stats is not None:
            ...
            self.log('Validation acc: %g at step %d' % (valid_stats.accuracy(), step))
...
class Statistics(object):
    ...
    * elapsed time
    ...
    def __init__(self, loss=0, n_docs=0, n_sents=0, n_correct=0):
        self.loss = loss
        self.n_docs = n_docs
    ...
    def accuracy(self):
        return 100 * (self.n_correct / self.n_sents)
    ...
    def output(self, step, num_steps, learning_rate, start):
        ...
        logger.info(
            ("Step %s; acc: %6.2f; xent: %6.4f; samples: %s; " +
