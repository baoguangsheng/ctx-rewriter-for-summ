...
class Statistics(object):
    ...
    * elapsed time
    ...
    def __init__(self, loss=0, n_words=0, n_correct=0, n_samples=0):
        self.loss = loss
    ...
    def output(self, step, num_steps, learning_rate, start):
        ...
        t = self.elapsed_time()
        logger.info(
            ("Step %2d/%5d; acc: %6.2f; ppl: %5.2f; xent: %4.2f; samples: %s; " +
    ...
    def log_tensorboard(self, prefix, writer, learning_rate, step):
        ...
        writer.add_scalar(prefix + "/samples", self.n_samples, step)
